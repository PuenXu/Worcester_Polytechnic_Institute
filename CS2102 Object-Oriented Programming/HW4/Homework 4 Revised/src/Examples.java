...
public class Examples {
	...
	//variables to test the helper functions
	IBinTree emptyBT = new MtBT();
	IHeap emptyHeap = new MtHeap();
	
	IBinTree BT1 = new DataBT(5,emptyBT,emptyBT);
	IBinTree BT2 = new DataBT(4,emptyBT,emptyBT);
	IBinTree BT3 = new DataBT(2,BT1,emptyBT);
	IBinTree BT4 = new DataBT(4,emptyBT,BT1);
	IBinTree BT5 = new DataBT(3,BT1,BT2);
	IBinTree BT6 = new DataBT(6,BT1,BT2);
	IBinTree BT7 = new DataBT(1,BT3,BT5);
	IBinTree BT8 = new DataBT(1,BT6,BT5);
	IBinTree BT9 = new DataBT(1,new DataBT(3,new DataBT(4,emptyBT,emptyBT),
										   new DataBT(6,emptyBT,emptyBT)),
							  new DataBT(5,new DataBT(7,emptyBT,emptyBT),
										   new DataBT(8,emptyBT,emptyBT)));
	IBinTree BT10 = new DataBT(4,new DataBT(3,new DataBT(4,emptyBT,emptyBT),
			   								new DataBT(6,emptyBT,emptyBT)),
							   new DataBT(5,new DataBT(7,emptyBT,emptyBT),
											new DataBT(8,emptyBT,emptyBT)));
	IBinTree BT11 = new DataBT(2,new DataBT(3,new DataBT(4,emptyBT,emptyBT),
											new DataBT(6,emptyBT,emptyBT)),
							   new DataBT(5,new DataBT(7,emptyBT,emptyBT),
											new DataBT(4,emptyBT,emptyBT)));
	IBinTree BT12 = new DataBT(4,new DataBT(1,new DataBT(3,emptyBT,emptyBT),
											new DataBT(2,emptyBT,emptyBT)),
							   new DataBT(5,new DataBT(7,emptyBT,emptyBT),
											new DataBT(4,emptyBT,emptyBT)));
	
	IHeap heap1 = new DataHeap(5,emptyHeap,emptyHeap);
	IHeap heap2 = new DataHeap(4,emptyHeap,emptyHeap);
	IHeap heap3 = new DataHeap(2,heap1,emptyHeap);
	IHeap heap4 = new DataHeap(2,heap2,emptyHeap);
	IHeap heap5 = new DataHeap(1,new DataHeap(3,new DataHeap(6,emptyHeap,emptyHeap),
												   new DataHeap(4,emptyHeap,emptyHeap)),
									new DataHeap(5,new DataHeap(7,emptyHeap,emptyHeap),
												   emptyHeap));
	IHeap heap6 = new DataHeap(1,new DataHeap(3,new DataHeap(6,emptyHeap,emptyHeap),
			   									   new DataHeap(4,emptyHeap,emptyHeap)),
									new DataHeap(5,new DataHeap(2,emptyHeap,emptyHeap),
												   emptyHeap));
	
	
	//variables to test heap checker functions
    ...
    public void testIsHeap1() {
    	assertTrue(emptyBT.isHeap());
    }
    
    //heap with no subtree
    @Test
    public void testIsHeap2() {
    	assertTrue(BT1.isHeap());
    }
    
    //heap with only 1 subtree
    @Test
    public void testIsHeap3() {
    	assertTrue(BT3.isHeap());
    }
    
    //heap with only 1 subtree
    @Test
    public void testIsHeap4() {
    	assertTrue(BT4.isHeap());
    }
    
    //heap with 2 subtrees
    @Test
    public void testIsHeap5() {
    	assertTrue(BT5.isHeap());
    }
    
    //not a heap, with 2 layers
    @Test
    public void testIsHeap6() {
    	assertFalse(BT6.isHeap());
    }
    
    //heap with multiple layers
    @Test
    public void testIsHeap7() {
    	assertTrue(BT7.isHeap());
    }
    
    //not a heap, second layer bigger than third layer
    @Test
    public void testIsHeap8() {
    	assertFalse(BT8.isHeap());
    }
    
    //heap with multiple layers
    @Test
    public void testIsHeap9() {
    	assertTrue(BT9.isHeap());
    }
    
    //not a heap, first layer wrong
    @Test
    public void testIsHeap10() {
    	assertFalse(BT10.isHeap());
    }
    
    //not a heap, third layer wrong
    @Test
    public void testIsHeap11() {
    	assertFalse(BT11.isHeap());
    }
    
    //not a heap, multiple layers wrong
    @Test
    public void testIsHeap12() {
    	assertFalse(BT12.isHeap());
    }
    
    //test for all elements exist in
    @Test
    public void testAllElementsExistIn1() {
    	assertTrue(emptyHeap.allElementsExistIn(emptyBT));
    }
	
    @Test
    public void testAllElementsExistIn2() {
    	assertTrue(heap1.allElementsExistIn(BT1));
    }
    
    @Test
    public void testAllElementsExistIn3() {
    	assertFalse(heap2.allElementsExistIn(BT1));
    }
    
    @Test
    public void testAllElementsExistIn4() {
    	assertTrue(heap3.allElementsExistIn(BT3));
    }
    
    @Test
    public void testAllElementsExistIn5() {
    	assertFalse(heap4.allElementsExistIn(BT3));
    }
    
    @Test
    public void testAllElementsExistIn6() {
    	assertTrue(heap5.allElementsExistIn(BT9));
    }
    
    @Test
    public void testAllElementsExistIn7() {
    	assertFalse(heap6.allElementsExistIn(BT9));
    }
	...
	@Test
	// tests for an empty heap, result is a empty tree
    public void testremMinEltValidatorForEmptyHeap(){
        assertTrue(HT.remMinEltValidator(emptyHeap, emptyBT));}
	
	@Test
	// tests for an empty heap, the result is not an empty tree
    public void testremMinEltValidatorForEmptyHeapResultNotEmpty(){
        assertFalse(HT.remMinEltValidator(emptyHeap, myBinTree6));}
}
