...
float milliDegToDeg = 1000.0;
float LSM6::predictedAngle(){
  return g.y * mdpsPerLSB / milliDegToDeg / 180.0 * M_PI / 26.0;     //26.0 is the hz rate of the ACC
}
