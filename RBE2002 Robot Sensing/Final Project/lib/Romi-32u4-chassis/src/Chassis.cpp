...
//   Serial.println(chassis.theta);
    checker = true;
   // Serial.println("XLoc: " + String(xLoc) + "\t" + "YLoc: " + String(yLoc) + "\t" + "Time: " + millis());
...
float currTime;
bool turnR = true;
void Chassis::turn(bool rightorleft)
{
    float speed = 10;
    float turnTime = 1171;
    if(turnR){
...
void Chassis::driveFor(float distanceInCM, bool& drive60cmParam, bool& arrivedParam){

    long sampleTime = distanceInCM * 100;
    //long printTime = 200;
