...
public:
    ...
    void stop(void);
    void turn();
    void turn360deg(bool& turn360degParam, bool& turnedParam);
    void drive60cm(bool& drive60cmParam, bool& arrivedParam);
    void drawArc(bool& drawArcParam, bool& drewParam);
